...
const Hero: React.FC<HeroProps> = ({ isVisible }) => {
  ...
  const carouselImages = [
    "../assests/AdobeStock_1318579643_Preview.jpeg", // Replace with your image paths
    "../assests/AdobeStock_1401571459_Preview.jpeg",
    "../assests/AdobeStock_1574627043_Preview.jpeg",
  ];
