...
const Hero: React.FC<HeroProps> = ({ isVisible }) => {
  ...
  const carouselImages = [
    "images/AdobeStock_1318579643_Preview.jpeg", // Replace with your image paths
    "images/AdobeStock_1401571459_Preview.jpeg",
    "images/AdobeStock_1574627043_Preview.jpeg",
  ];
