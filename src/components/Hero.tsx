...
const Hero: React.FC<HeroProps> = ({ isVisible }) => {
  ...
  const carouselImages = [
    "../static/images/AdobeStock_1318579643_Preview.jpeg", // Replace with your image paths
    "../static/images/AdobeStock_1401571459_Preview.jpeg",
    "../static/images/AdobeStock_1574627043_Preview.jpeg",
  ];
